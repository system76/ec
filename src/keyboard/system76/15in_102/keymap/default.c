...
LAYOUT(
    _______, K_TOUCHPAD, K_DISPLAY_TOGGLE, K_MUTE, _______, K_VOLUME_DOWN, K_VOLUME_UP, K_DISPLAY_MODE, K_BRIGHTNESS_DOWN, K_BRIGHTNESS_UP, K_CAMERA_TOGGLE, K_AIRPLANE_MODE, K_SUSPEND, _______, K_SCROLL_LOCK, _______, _______, _______, K_PAUSE, K_PAUSE,
    K_PLAY_PAUSE, K_FAN_TOGGLE, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, K_KBD_COLOR, K_KBD_TOGGLE, K_KBD_DOWN,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, K_KBD_UP,
