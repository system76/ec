...
#define CHARGE_VOLTAGE CHARGER_CHARGE_VOLTAGE
...
#define INPUT_CURRENT_MASK 0x0F80
    ...
    #define INPUT_CURRENT (CHARGER_INPUT_CURRENT >> 2)
    #define ADAPTER_RSENSE RSENSE_5
#elif CHARGER_ADAPTER_RSENSE == 10
    #define INPUT_CURRENT (CHARGER_INPUT_CURRENT >> 1)
    #define ADAPTER_RSENSE RSENSE_10
#elif CHARGER_ADAPTER_RSENSE == 20
    #define INPUT_CURRENT CHARGER_INPUT_CURRENT
